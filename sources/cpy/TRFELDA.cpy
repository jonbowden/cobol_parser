      ...
      *=================================================================
      -    ======
      * MY1CR1 - CRISTINA  14/03/2013 - UOBM REM PROJECT SIT JIRA LOG
      -    6974
      ...
      *
      * ID1DV1 - DAENIELV  30/08/2011 - UOBI REM PROJECT
      ...
      *     L-N-QUENUM AS NEW INDINDICATOR

      *      FOR RECHECK/OVERRIDE EARMARK
      *=============================================================
      *--------------- LOCAL DATA AREA - 17 OCT 1989 ---------------*
      ...
      *----------------------------------------------------------------*
           ...
           05  L-N-G-PAY-TOLRN        PIC S9(13)V99.
           05  L-C-RDS                PIC X(01).
              88  RDS                VALUE "Y".
              88  NO-RDS             VALUE "N".
           ...
           10  L-N-G-FX-RATE      PIC S9(04)V9(06).
           10  L-N-G-FX-RATE      PIC S9(09)V9(07).
           10  L-N-G-PAYBAMT      PIC S9(13)V99.
           10  L-N-G-DAYS         PIC 9(03).
           10  L-N-G-COR-CHG-AMT-1 PIC S9(13)V99.
           10  L-N-G-COR-CHG-AMT-2 PIC S9(13)V99.
      ...
      *950831*** 950830 REMITTANCE ENHANCEMENT ---
      *950831*** L-C-G-LOAN-CUY-IND is used for temp. parameter to
      *950831*** pass the status of the transaction(deo/ver/app) to the
      *950831*** following routine --> TREEDPGL, TRFMCCIN, TRFXDMSG
      *950831*** "V" for ver, "A" for app.
      *950831*** if l-c-g-loan-cuy-ind = "S", this is to indicate the
      *950831*** transaction is in TREEIRR/TREEIRRM function and
      -    TRFMCCIN
      *950831*** should provide F12 function key.
           10  L-C-G-LOAN-CUY-IND PIC X(01).
           10  L-C-G-CUST-AC-NO   PIC X(11).
           ...
           05  L-C-APPROVAL.
           10  L-C-APP-ACCNO      PIC X(12).
           10  L-C-APP-ACCNO      PIC X(15).

      *
           10  L-C-APP-BNKBR      PIC X(03).
           10  L-C-APP-BNKBR      PIC X(04).
           10  L-C-APP-CUSTTYP    PIC X(01).
           10  L-N-APP-VALUEDTE   PIC 9(08).
           10  L-C-APP-ORDCUST    PIC X(35).
      *--- ADDITIONAL FIELD FOR EXPANDED QUENUM FR 5 TO 8 BYTES ---*
           05 L-N-XPN-QUENUM  PIC 9(08).
           05 L-C-BASECD     PIC X(01).
              ID1DV1*  05 FILLER         PIC X(79).
ID1DV1     05 L-C-USERBNKBR  PIC X(04).
              MY1AT1*  05 FILLER         PIC X(75).
MY1AT1     05 L-C-RBK-IBL-MSG PIC X(35).
              MY1CR1*  05 FILLER         PIC X(40).
MY1CR1     05 L-C-BNM-TAG    PIC X(08).
MY1CR1     05 FILLER         PIC X(32).
