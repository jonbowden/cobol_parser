...
*                                    This file is a duplicate of TFSICLSA
...
*********************************************************************
***     05 WK-ISLSAQ-OUTPUT.
***         10 WK-O-ISLSAQ-MQ-HEADER.
     APPLISYS                  5A
     MQSERNO                  4S 0
     RTNDATAQNM              10S 0
     MQRTNCODE               10A
     FILLER001                4A
***         10 WK-O-ISLSAQ-MSG-HEADER.
     TRANCODE                 3A
     TELLERID                 4A
     TLRTRNSSQN              4S 0
     REVIND                   1A
...
**         Customer Type
     CUSTTYPE                2S 0
     STATUS                  2S 0
**         00 - NORMAL; 02 - DORMANT; 03 - CLOSED
     HOLDA                   2S 0
     HOLDB                   2S 0
     HOLDC                   2S 0
     SHORTNAME               20A
*         # of ID
     OLNOIDS                 1S 0
*         1st ID Code and Number
     IDACDE                   1A
     IDANUM                  30A
*         2nd ID Code and Number
     IDBCDE                   1A
     IDBNUM                  30A
     STAFFCODE               2S 0
     RESCODE                 2S 0
