      ...
      *-----------------------------------------------------------------*
       ...
       B100-PATH-CHOICE.
                                               ...
                                               IF  TAG56-OPT = SPACES
                                                   ...
                                                   ELSE
                                                       ...
                                                       CMP3A3        IF  (TAG56-OPT = "A" AND
                                                       CMP3A3            TAG56-BIC = "UOVBSGSGXXX")
                                                       CMP3A3        OR  (TAG56-OPT = "A" AND
                                                       CMP3A3*CMR4A1 TFSSTPL-SWFTMGTY = 101 AND
       CMP3A3            TAG56-BIC = WK-C-SWIFTBICCDE)
       ...
       END-IF.
                                                   ...
                                                   CMP3A3  IF (TAG57-OPT = "A" AND
                                                   CMP3A3      TAG57-BIC = "UOVBSGSGXXX")
                                                   CMP3A3  OR (TAG57-OPT = "A" AND
                                                   CMP3A3*CMRAA1 TFSSTPL-SWFTMGTY = 101 AND
       CMP3A3      TAG57-BIC = WK-C-SWIFTBICCDE)
      ...
      *CMP3A3   TAG57-BIC    = WK-C-SWIFTBICCDE)
       ...
       END-IF.
                                                           ...
                                                           CMP3A3     IF (TAG57-OPT    = "A"           AND
                                                           CMP3A3     TAG57-BIC        NOT = SPACES    AND
                                                           CMP3A3     TAG57-BIC        NOT = "UOVBSGSGXXX" AND
                                                           CMP3A3     TAG57-BIC        NOT = "MASGSGSGXXX")
                                                           CMP3A3     OR (TAG57-OPT    = "A"           AND
                                                           CMP3A3*CMRA1 TFSSTPL-SWFTMGTY = 101         AND
                                                           CMP3A3     TAG57-BIC        NOT = SPACES    AND
                                                           CMP3A3     TAG57-BIC        NOT = "MASGSGSGXXX" AND
       CMP3A3     TAG57-BIC        NOT = WK-C-SWFTBICCDE)
                                                       IF MEP57-IND     = "Y"
       ...
       END-IF.
                                                               ...
                                                               CMP3A3        TAG57-BIC  NOT = SPACES            AND
                                                               CMP3A3        TAG57-BIC  NOT = "MASGSGSGXXX"     AND
                                                               CMP3A3        TAG57-BIC  NOT = WK-C-SWIFTBICCODE)
                                                           IF  MEPS57-IND = "N"
                                                                   AND BKAC57-IND = "Y"
