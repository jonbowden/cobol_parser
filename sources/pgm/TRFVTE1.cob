...
DIVKIE  01  WK-C-SWIFTBICDCE       PIC X(11) VALUE SPACE.
DIVKIE  01  WK-C-RTGSBICDCE        PIC X(11) VALUE SPACE.
...
2BL00           AND WK-C-FILE-STATUS NOT = "41"
2BL00           DISPLAY "UFIMIJCON - OPEN FILE ERROR - UFIMIJCON"
2BL00           DISPLAY "FILE STATUS IS " WK-C-FILE-STATUS
2BL00           END-IF
                 END-IF.
...
D1VKE        MOVE TFSBNKET-BNKENTTY TO TFSBNKET-BNKENTTY
D1VKE        READ TFSBNKET KEY IS EXTERNALLY-DESCRIBED-KEY
D1VKE        INVALID KEY
D1VKE           MOVE SPACES       TO WK-C-SWIFTBICCODE
D1VKE        NOT INVALID KEY
D1VKE           MOVE TFSBNKET-SWFTBNK TO WK-C-SWIFTBICCODE
D1VKE        END-READ
...
REM269      IF TFSSTPL-CUYCD NOT = WK-C-LCUYCD
                  ...
                  COMPUTE WS-LCAMT ROUNDED = 
                      TFSSTPL-AMT * WK-N-GERTE-EXCH-RTE
                      / WK-N-GERTE-FXRATETU
           ELSE
